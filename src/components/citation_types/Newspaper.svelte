...
<script lang="ts">
    ...
    <form>
        ...
        <div class="form-group">
            ...
            <input id="SeriesNum" type="text" placeholder="Section"bind:value={source.series_num}>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input id="Place" type="text" placeholder="Place" bind:value={source.publishing_location}>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input id="ISBN" type="text" placeholder="ISSN" bind:value={source.isbn}>
        </div>
