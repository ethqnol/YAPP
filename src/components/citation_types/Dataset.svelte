...
<script lang="ts">
    ...
    <form>
        ...
        <div class="form-group">
            ...
            <input id="Edition" type="text" placeholder="Version" bind:value={source.edition}>
        </div>
        <div class="form-group">
            <label for="Place">Repo. Location</label>
            <input id="Place" type="text" placeholder="Repo. Location" bind:value={source.publishing_location}>
        </div>
        <div class="form-group">
            <label for="Publisher">Repository</label>
            <input id="Publisher" type="text" placeholder="Repository" bind:value={source.publishing_company}>
        </div>
        <div class="form-group">
